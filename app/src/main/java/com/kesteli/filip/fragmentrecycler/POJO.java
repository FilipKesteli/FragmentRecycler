...
public class POJO {
    ...
    private String[] poslovi = {"automobil", "kompjutor", "vesmasina", "fizika", "matematika", "kemija", "poljoprivreda", "pazitelj", "gradevina"};

    public String[] getPoslovi() {
        return poslovi;
    }

    public void setPoslovi(String[] poslovi) {
